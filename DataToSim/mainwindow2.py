...
#
# Created: Wed Dec  7 16:47:07 2016
...
class Ui_DataToSim(object):
    def setupUi(self, DataToSim):
        ...
        self.pathTextEdit.setMaximumSize(QtCore.QSize(600, 30))
        self.pathTextEdit.setInputMethodHints(QtCore.Qt.ImhNone)
        self.pathTextEdit.setObjectName(_fromUtf8("pathTextEdit"))
        self.browseLayout.addWidget(self.pathTextEdit)
